package net.lopymine.pc.config.cache;
...
public class KnownPlayerUUIDsConfig {
	...
	private static final File CONFIG_FILE = MossyLoader.getConfigDir().resolve(PlayerCushions.MOD_ID + "-known-player-uuids" + ".json5").toFile();
	private static final Logger LOGGER = LoggerFactory.getLogger(PlayerCushions.MOD_NAME + "/KnownPlayerUUIDsConfig");
